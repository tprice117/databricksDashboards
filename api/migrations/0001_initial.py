# Generated by Django 4.1.1 on 2023-02-02 15:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, db_column='Product__c', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(db_column='IsDeleted', default=False, verbose_name='Deleted')),
                ('is_archived', models.BooleanField(db_column='IsArchived', default=False, verbose_name='Archived')),
                ('pricebook', models.ForeignKey(db_column='PricebookId', on_delete=django.db.models.deletion.DO_NOTHING, to='api.pricebook', verbose_name='Price Book ID')),
                ('product', models.ForeignKey(db_column='ProductId', on_delete=django.db.models.deletion.DO_NOTHING, to='api.product', verbose_name='Product ID')),
            ],
        ),
        migrations.CreateModel(
            name='PostalCode',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pricebook', models.ForeignKey(blank=True, db_column='PricebookId', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.pricebook', verbose_name='Price Book ID')),
        ...
        migrations.AddField(
            ...
            name='pricebook',
            field=models.ForeignKey(blank=True, db_column='PricebookId', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.pricebook', verbose_name='Price Book ID'),
        ),
        migrations.AddField(
            model_name='opportunity',
            name='product',
            field=models.ForeignKey(blank=True, db_column='Product__c', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.product'),
        ),
        migrations.AddField(
            model_name='opportunity',
