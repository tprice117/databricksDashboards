...
class OrderGroupSerializer(serializers.ModelSerializer):
    ...
    user_address_id = serializers.PrimaryKeyRelatedField(queryset=UserAddress.objects.all(), source='user_address', write_only=True)
    seller_product_seller_location = SellerProductSellerLocationSerializer(read_only=True)
    seller_product_seller_location_id = serializers.PrimaryKeyRelatedField(queryset=SellerProductSellerLocation.objects.all(), source='seller_product_seller_location', write_only=True)
    waste_type = WasteTypeSerializer(read_only=True)
    waste_type_id = serializers.PrimaryKeyRelatedField(queryset=WasteType.objects.all(), source='waste_type', write_only=True, allow_null=True)
    time_slot = TimeSlotSerializer(read_only=True)
    time_slot_id = serializers.PrimaryKeyRelatedField(queryset=TimeSlot.objects.all(), source='time_slot', write_only=True, allow_null=True)
