...
def sync_stripe_payment_methods():
    ...
    for payment_method in payment_methods:
        sync_stripe_payment_method(payment_method=payment_method)


def sync_stripe_payment_method(payment_method: PaymentMethod):
    ...
    for user_address in user_addresses:
        ...
        if not stripe_payment_method:
            try:
                response = _create_stripe_payment_method(payment_method=payment_method)
