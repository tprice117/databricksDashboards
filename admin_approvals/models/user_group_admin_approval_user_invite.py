    ...
    def save(self, *args, **kwargs):
        ...
        if self._state.adding is True:
            if self.created_by.type == "ADMIN":
                ...
                save_object = False
            elif self.user_group.policy_user_invitations is not None:
                policy = self.user_group.policy_user_invitations.filter(
            ...
            # The object was updated. Do something else here.
            pass
