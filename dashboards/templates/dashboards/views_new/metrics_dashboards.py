...
def user_groups_dashboard(request):
    ...
    ).aggregate(average=Avg("total_spend"))["average"] or Decimal("0.00")
...
def time_to_acceptance(request):
    ...
    avg_time_to_accepted_hours = (
        orders_with_time_to_acceptance.aggregate(
            avg_time_to_accepted=Avg("time_to_accepted_hours")
        )["avg_time_to_accepted"]
        or 0.0
    )

    # Calculate the average time to completed in hours
    avg_time_to_completed_hours = (
        orders_with_time_to_acceptance.aggregate(
    ...
    orders_by_day = (
        ...
        .annotate(
            internal_count=Count(
                "id",
                filter=Q(
                    accepted_by__user_group_id="bd49eaab-4b46-46c0-a9bf-bace2896b795"
                ),
            ),
    ...
    avg_time_to_accepted_by_day = (
        orders_with_time_to_acceptance.values("end_date")
    ...
    # hashmap data
    context["avg_time_to_completed_chart_data"] = json.dumps(
        avg_time_to_completed_chart_data
    )
    context["avg_time_to_accepted_chart_data"] = json.dumps(
        avg_time_to_accepted_chart_data
    )
