...
if ENVIRONMENT == 'TEST':
    ...
    CHECKBOOK_API_KEY = "420daa76cfc24dfd9fdbdb3695be609e"
    CHECKBOOK_API_SECRET = "SinAr3yqzGwFt3ET4s9Dw0SLyD17Y8"
    CHECKBOOK_WEBHOOK_KEY = "e4f8658477de42af8012acf3891b6fe6"
else:    
