...
router.register(r'main-product-variations', views.MainProductVariationViewSet, 'api')
...
router.register(r'main-product-variation-add-on-choices', views.MainProductVariationAddOnChoiceViewSet, 'api')
