...
class UserGroupPolicyInvitationApprovalViewSet(viewsets.ModelViewSet):
    queryset = UserGroupPolicyInvitationApproval.objects.all()
    serializer_class = UserGroupPolicyInvitationApprovalSerializer
